...
def plt_tpcds_multi_cp_relative_error():
    ...
    p1 = plt.bar(X + 0.00, data[0], color=colors["DBEst_10k"], width=width   , alpha=alpha['2'])
    p2 = plt.bar(X + 0.20, data[1], color=colors["BlinkDB_10k"], width=width , alpha=alpha['3'])
    p3 = plt.bar(X + 0.40, data[2], color=colors["DBEst_100k"], width=width  , alpha=alpha['4'])
    p4 = plt.bar(X + 0.60, data[3], color=colors["BlinkDB_100k"], width=width, alpha=alpha['6'])
...
def plt_tpcds_multi_cp_memory_usage():
    ...
    p1 = plt.bar(X + 0.00, data[0], color=colors["DBEst_10k"], width=width   , alpha=alpha['2'])
    p2 = plt.bar(X + width, data[1], color=colors["BlinkDB_10k"], width=width, alpha=alpha['6'])
    # p3 = plt.bar(X + 0.30, data[2], color=colors["BlinkDB_10k"], width=width)
...
def plt_tpcds_single_cp_sample_size_response_time():
    ...
    p1 = plt.bar(X + 0.00, data[0], color=colors["lightgreen"], width=width, alpha=alpha['2'])
    p2 = plt.bar(X + 0.20, data[1], color=colors["green"], width=width     , alpha=alpha['3'])
    p3 = plt.bar(X + 0.40, data[2], color=colors["BlinkDB_1m"], width=width, alpha=alpha['4'])
    p4 = plt.bar(X + 0.60, data[3], color=colors["BlinkDB_5m"], width=width, alpha=alpha['6'])
...
def plt_tpcds_single_cp_sample_size_relative_error_blinkdb():
    ...
    p1 = plt.bar(X + 0.00, data[0], color=colors["lightgreen"], width=width    , alpha=alpha['2'])
    p2 = plt.bar(X + 1*width, data[1], color=colors["green"], width=width      , alpha=alpha['3'])
    p3 = plt.bar(X + 2*width, data[2], color=colors["BlinkDB_1m"], width=width , alpha=alpha['4'])
    p4 = plt.bar(X + 3*width, data[3], color=colors["BlinkDB_5m"], width=width , alpha=alpha['5'])
    p5 = plt.bar(X + 4*width, data[4], color=colors["BlinkDB_26m"], width=width, alpha=alpha['6'])
...
def plt_tpcds_single_cp_query_range_relative_error():
    ...
    p1 = plt.bar(X + 0.00, data[0], color=colors["lightgreen"], width=width, alpha=alpha['2'])
    p2 = plt.bar(X + 0.20, data[1], color=colors["green"], width=width     , alpha=alpha['4'])
    p3 = plt.bar(X + 0.40, data[2], color=colors["BlinkDB_1m"], width=width, alpha=alpha['6'])
...
def plt_ccpp_multi_cp_training_time():
    ...
    p1 = plt.bar(X + 0.00, data[0], color=colors["orange"], width=width             , alpha=alpha['2'])
    p2 = plt.bar(X + 0.00, data[1], color=colors["red"], width=width,bottom=data[0] , alpha=alpha['4'])
    p3 = plt.bar(X + 0.30, data[2], color=colors["BlinkDB_10k"], width=width        , alpha=alpha['6'])
...
def plt_group_by_relative_error():
    ...
    p1 = plt.bar(X + 0.00, data[1], color=colors["DBEst_10k"], width=width  , alpha=alpha['2'])
    p2 = plt.bar(X + 0.20, data[0], color=colors["BlinkDB_10k"], width=width, alpha=alpha['6'])
...
def plt_group_by_response_time():
    ...
    p1 = plt.bar(X + 0.00, data[1], color=colors["DBEst_10k"], width=width   , alpha=alpha['2'])
    p2 = plt.bar(X + width, data[0], color=colors["BlinkDB_10k"], width=width, alpha=alpha['6'])
    # p3 = plt.bar(X + 0.40, data[2], color=colors["DBEst_100k"], width=width)
    # p4 = plt.bar(X + 0.60, data[3], color=colors["BlinkDB_100k"], width=width)
...
def plt_group_by_training_time():
    ...
    p1 = plt.bar(X + 0.00, data[0], color=colors["orange"], width=width         , alpha=alpha['2'])
    p2 = plt.bar(X + 0, data[1], color=colors["red"], width=width,bottom=data[0], alpha=alpha['4'])
    p3 = plt.bar(X + 1, data[2], color=colors["BlinkDB_10k"], width=width       , alpha=alpha['6'])
...
def plt_group8_by_relative_error():
    ...
    p1 = plt.bar(X + 0.00, data[1], color=colors["DBEst_10k"], width=width   , alpha=alpha['2'])
    p2 = plt.bar(X + 0.20, data[0], color=colors["BlinkDB_10k"], width=width , alpha=alpha['3'])
    p3 = plt.bar(X + 0.40, data[3], color=colors["DBEst_100k"], width=width  , alpha=alpha['4'])
    p4 = plt.bar(X + 0.60, data[2], color=colors["BlinkDB_100k"], width=width, alpha=alpha['6'])

    
    plt.legend((p1[0], p2[0],p3[0], p4[0]),
        ('DBEst', 'BlinkDB','DBEst_100k','BlinkDB_100k'), loc='1', prop={'size': 18})
    ...
    plt.show()
    fig.savefig("/home/u1796377/Desktop/figures/group8_by_reltive_error.pdf", bbox_inches='tight')
...
def plt_group8_by_response_time():
    ...
    p1 = plt.bar(X + 0.00, data[1], color=colors["DBEst_10k"], width=width      , alpha=alpha['2'])
    p2 = plt.bar(X + width, data[0], color=colors["BlinkDB_10k"], width=width   , alpha=alpha['3'])
    p3 = plt.bar(X + 2*width, data[3], color=colors["DBEst_100k"], width=width  , alpha=alpha['4'])
    p4 = plt.bar(X + 3*width, data[2], color=colors["BlinkDB_100k"], width=width, alpha=alpha['6'])

    
    plt.legend((p1[0], p2[0],p3[0], p4[0]),
        ('DBEst', 'BlinkDB','DBEst_100k','BlinkDB_100k'), loc='upper center')
    ...
    plt.show()
    fig.savefig("/home/u1796377/Desktop/figures/group8_by_response_time.pdf", bbox_inches='tight')
...
def plt_group8_by_training_time():
    ...
    p1 = plt.bar(X + 0.00, data[0], color=colors["orange"], width=width,alpha=alpha["1"])
    p2 = plt.bar(X + 0, data[1], color=colors["red"], width=width,bottom=data[0],alpha=alpha["3"])
    p3 = plt.bar(X + width, data[2], color=colors["BlinkDB_10k"], width=width,alpha=alpha["5"])
    # p1[1].set_color(colors["BlinkDB_10k"])
    ...
    plt.show()
    fig.savefig("/home/u1796377/Desktop/figures/group8_by_training_time.pdf", bbox_inches='tight')
...
def plt_group8_by_memory_usage():
    ...
    p1 = plt.bar(X , data[0], color=colors["DBEst_10k"], width=width,alpha=alpha["3"])
    p2 = plt.bar(X + width, data[1], color=colors["BlinkDB_10k"], width=width,alpha=alpha["6"])
    # p3 = plt.bar(X + 0.30, data[2], color=colors["BlinkDB_10k"], width=width)
    ...
    plt.show()
    fig.savefig("/home/u1796377/Desktop/figures/group8_by_memory_usage.pdf", bbox_inches='tight')
...
0.00354465,
    ...
    fig, ax = plt.subplots()
    plt.hist(x,501,normed=1,cumulative=True,color=colors["BlinkDB_10k"],alpha=0.8)
    plt.xlim(0,0.1)
    plt.ylim(0,1)
    formatter = FuncFormatter(to_percent)
...
def plt_group8_by_detail_error():
    ...
    width = 0.20
    data = [
      [0.0278,  0.0060,  0.0393,  0.0158,  0.0183,  0.0167, 0.0269, 0.0075   ],#, 0.0486],
      [0.0705,  0.0143,  0.0189,  0.0440,  0.0330,  0.0518, 0.0414, 0.0449   ],#, 0.0335],
      ]
    ...
    p1 = plt.bar(X + 0.00, data[0], color=colors["DBEst_10k"], width=width,alpha=alpha["2"])
    p2 = plt.bar(X + 0.20, data[1], color=colors["BlinkDB_10k"], width=width,alpha=alpha["6"])
    # p3 = plt.bar(X + 0.40, data[2], color=colors["DBEst_100k"], width=width)
    # p4 = plt.bar(X + 0.60, data[3], color=colors["BlinkDB_100k"], width=width)
    ...
    plt.show()
    fig.savefig("/home/u1796377/Desktop/figures/group8_by_detail_error.pdf", bbox_inches='tight')
...
def min_max():
    ...
    p1 = plt.bar(X + 0.00, data[0], color=colors["BlinkDB_1k"], width=width     , alpha=alpha['2'])
    p2 = plt.bar(X + 0.20, data[1], color=colors["BlinkDB_10k"], width=width    , alpha=alpha['3'])
    p3 = plt.bar(X + 0.40, data[2], color=colors["BlinkDB_100k"], width=width   , alpha=alpha['4'])
    p4 = plt.bar(X + 0.60, data[3], color=colors["BlinkDB_1m"], width=width     , alpha=alpha['6'])
    ...
    plt.show()
    fig.savefig("/home/u1796377/Desktop/figures/min_max.pdf", bbox_inches='tight')

if __name__ == "__main__":
    plt_group_by_training_time()
